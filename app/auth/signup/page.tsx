...
export default function SignupPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <h1 className="text-3xl font-bold neon-text">Get Started</h1>
        <p className="text-muted-foreground">Create your GlassBudget account today</p>
      </motion.div>
      ...
      >
        ...
        <motion.div custom={0} variants={inputVariants} initial="hidden" animate="visible">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white/10 border border-white/20 rounded-lg pl-10 pr-4 py-2.5 text-foreground placeholder-muted-foreground focus:outline-none focus:border-cyan-400 focus:bg-white/15 transition-all disabled:opacity-50"
        ...
        <motion.div custom={3} variants={inputVariants} initial="hidden" animate="visible">
          <label className="flex items-start gap-2 text-sm cursor-pointer">
            <input
              type="checkbox"
              className="w-4 h-4 rounded border-white/20 bg-white/5 accent-cyan-400 mt-0.5"
              required
              disabled={loading}
            />
            <span>
        ...
        <motion.button
          ...
          type="submit"
          disabled={loading}
          className="w-full bg-gradient-to-r from-cyan-400 to-emerald-400 hover:shadow-lg hover:shadow-cyan-400/50 text-slate-950 font-bold py-2.5 rounded-lg transition-all duration-300 flex items-center justify-center gap-2 mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
